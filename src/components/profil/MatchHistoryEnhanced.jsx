...
// Import des utilitaires d'images depuis le service riotAPI
import { getChampionImage, getItemImage, getSummonerSpellImage } from '../../services/riotAPI';

const MatchHistoryEnhanced = ({ matches }) => {
      ...
      <div className="flex items-center space-x-2 w-24">
        <div className="relative">
          <img 
            ...
            onError={(e) => {
              e.target.src = 'https://via.placeholder.com/40x40/374151/9CA3AF?text=?';
            }}
          />
        ...
        <div className="flex flex-col space-y-0.5">
          <img 
            ...
            onError={(e) => {
              e.target.src = 'https://via.placeholder.com/16x16/374151/9CA3AF?text=?';
            }}
          />
          <img 
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex flex-col space-y-1">
                      <img 
                        ...
                        onError={(e) => {
                          e.target.src = 'https://via.placeholder.com/24x24/374151/9CA3AF?text=?';
                        }}
                      />
                      <img 
...
export default MatchHistoryEnhanced;