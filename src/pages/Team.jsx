      ...
      <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <nav>
          <ul className="flex space-x-6 items-center">
            ...
            <li><a href="/profil" className="text-blue-400 font-semibold">Profil</a></li>
            <li><a href="/analyse" className="hover:text-blue-400 transition-colors">Analyse</a></li>
            <li><a href="/data-champ" className="hover:text-blue-400 transition-colors">Data Champ</a></li>
            <li><a href="/amelioration" className="hover:text-blue-400 transition-colors">Amélioration</a></li>
